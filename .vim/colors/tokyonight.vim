...
if s:configuration.style ==# 'night'
  let s:palette = {
        \ 'black':      [color0,   '237',  'DarkGrey'],
        \ 'bg0':        [background,   '235',  'Black'],
        \ 'bg1':        [color0,   '236',  'DarkGrey'],
        \ 'bg2':        [color0,   '236',  'DarkGrey'],
        \ 'bg3':        [color1,   '237',  'DarkGrey'],
        \ 'bg4':        [color8,   '237',  'Grey'],
        ...
        \ 'fg':         [foreground,   '250',  'White'],
        \ 'red':        [color2,   '203',  'Red'],
        \ 'orange':     [color4,   '215',  'Orange'],
        \ 'yellow':     [color4,   '179',  'Yellow'],
        \ 'green':      [color3,   '107',  'Green'],
        \ 'blue':       [color5,   '110',  'Blue'],
        \ 'purple':     [color6,   '176',  'Magenta'],
        \ 'grey':       [color8,   '246',  'LightGrey'],
        \ 'none':       ['NONE',      'NONE', 'NONE']
        \ }
